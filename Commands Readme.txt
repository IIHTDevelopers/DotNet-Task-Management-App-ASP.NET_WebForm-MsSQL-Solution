...
(TaskManagementApp /sqlcmd -S localhost -U sa -P pass@word1)
	-To create database from terminal - 
	1> Create Database TaskManagementDb
	2> Go
...
* To run the test cases in CMD, Run the following command to test the application:
	(TaskManagementApp.Tests/dotnet test --logger "console;verbosity=detailed")
